...
export default function Impostazione(props) {
  ...
  return (
    <Pressable onPress={()=> navigation.navigate(props.nome)} style={{flex:0, alignItems:"center", flexDirection: "row",width: "100%", padding:20, borderBottomWidth: props.last ? 0:1, borderBottomColor: "#000"}}>
